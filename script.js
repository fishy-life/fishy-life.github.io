...
function animate(){
    ...
    ctx.font = '35px Georgia';
    ctx.fillStyle = 'rgba(255,255,255,0.8)';
    ctx.fillText('Topscore: ' + '1337', 391, 336); //To add logic later
    ctx.fillStyle = 'rgba(34,147,214,1)';
    ctx.fillText('Topscore: ' + '1337', 390, 335); //To add logic later
